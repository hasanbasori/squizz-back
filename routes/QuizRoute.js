...
router.get("/each-quiz/:id", CreatorControllers.protectCreator, QuizControllers.getEachQuiz);
// router.post("/create", CreatorControllers.protectCreator, QuizControllers.createQuizAndQuestions);
router.post("/create", CreatorControllers.protectCreator, QuizControllers.createDraftQuiz);
router.put("/update-quiz/:id", CreatorControllers.protectCreator, QuizControllers.updateQuizData);
router.delete("/:id", CreatorControllers.protectCreator, QuizControllers.deleteQuiz);
